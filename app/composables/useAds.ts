...
export const useAds = () => {
   ...
   */
  const fetchRandomFeaturedAd = async (): Promise<{
    data: FeaturedAd | null;
    error: string | null;
  }> => {
    try {
      ...
      logger.error(
        { error: errorMessage },
        "Unexpected error fetching featured ad",
      );
   ...
   */
  const fetchRandomFeaturedJob = async (
    context?: AdContext,
    ...
    try {
      ...
      if (job) {
        logger.debug(
          { jobId: job.id, contextual: !!context },
          "Featured job selected",
        );
      ...
      logger.error(
        { error: errorMessage },
        "Unexpected error fetching featured job",
      );
      return { data: null, error: errorMessage };
    }
  };
  ...
  const createFeaturedAd = async (
    ...
    try {
      ...
      logger.error(
        { error: errorMessage },
        "Unexpected error creating featured ad",
      );
      return { data: null, error: errorMessage };
    }
  };
  ...
  const createFeaturedJob = async (
    ...
    try {
      ...
      logger.error(
        { error: errorMessage },
        "Unexpected error creating featured job",
      );
      return { data: null, error: errorMessage };
    }
  };
  ...
  const fetchMyAds = async (
    ...
    try {
      ...
      logger.error(
        { error: errorMessage },
        "Unexpected error fetching user ads",
      );
  ...
  const updateAdStatus = async (
    ...
    try {
      ...
      logger.error(
        { error: errorMessage },
        "Unexpected error updating ad status",
      );
  ...
  const updateJobStatus = async (
    ...
    try {
      ...
      logger.error(
        { error: errorMessage },
        "Unexpected error updating job status",
      );
      return { success: false, error: errorMessage };
    }
  };
  ...
  const updateFeaturedAd = async (
    ...
    try {
      ...
      logger.error(
        { error: errorMessage },
        "Unexpected error updating featured ad",
      );
      return { data: null, error: errorMessage };
    }
  };
  ...
  const updateFeaturedJob = async (
    ...
    try {
      ...
      logger.error(
        { error: errorMessage },
        "Unexpected error updating featured job",
      );
      return { data: null, error: errorMessage };
    }
  };
  ...
  const fetchPendingAds = async (): Promise<{
    ...
    try {
      ...
      logger.error(
        { error: errorMessage },
        "Unexpected error fetching pending ads",
      );
      return { ads: [], jobs: [], error: errorMessage };
    }
  };
  ...
  const fetchAllAds = async (
    ...
    try {
      ...
      logger.error(
        { error: errorMessage },
        "Unexpected error fetching all ads",
      );
      return { ads: [], jobs: [], error: errorMessage };
    }
  };
  ...
  const generateJobEmbedding = async (
    ...
    try {
      ...
      if (response.success) {
        logger.info(
          { jobId, matchedMosCodes: response.matchedMosCodes },
          "Embedding generated",
        );
        return {
          success: true,
          matchedMosCodes: response.matchedMosCodes,
          error: null,
        };
      }
  ...
  const generateAdEmbedding = async (
    ...
    try {
      ...
      if (response.success) {
        logger.info(
          { adId, matchedMosCodes: response.matchedMosCodes },
          "Embedding generated",
        );
        return {
          success: true,
  ...
  const activateFeaturedJob = async (
    ...
    try {
      ...
      if (!embeddingResult.success) {
        logger.warn(
          { jobId },
          "Embedding generation failed, activating without MOS matching",
        );
      }
      ...
      return {
        success: false,
        matchedMosCodes: embeddingResult.matchedMosCodes,
        error: "Job activation not yet implemented",
      };
    } catch (err) {
      const errorMessage = err instanceof Error ? err.message : "Unknown error";
      logger.error(
        { error: errorMessage },
        "Unexpected error activating featured job",
      );
      return { success: false, matchedMosCodes: [], error: errorMessage };
    }
  };
