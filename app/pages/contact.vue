...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Get in touch with military.contractors. Questions, feedback, partnership inquiries, or support requests.'
    }
  ]
})
  ...
  <div class="min-h-full">
    ...
    <header class="border-b border-border">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl py-12 sm:py-16">
        <h1 class="text-2xl sm:text-3xl font-bold text-foreground">Contact</h1>
    ...
    <main class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl py-12">
      <div class="grid md:grid-cols-3 gap-12">
        ...
        <div class="space-y-6">
          <div>
            <h2 class="font-medium text-foreground">Email</h2>
            <a 
          ...
          <div>
            <h2 class="font-medium text-foreground">Response time</h2>
          ...
          <div>
            <h2 class="font-medium text-foreground">For companies</h2>
            <p class="text-sm text-muted-foreground">
          ...
          <form class="space-y-6" @submit.prevent="handleSubmit">
            ...
            <div>
              ...
              <Select v-model="form.subject">
                ...
                <SelectContent>
                  <SelectItem v-for="option in subjectOptions" :key="option" :value="option">
                    {{ option }}
                  </SelectItem>
                </SelectContent>
              </Select>
