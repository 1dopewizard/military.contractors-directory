...
/** Clearance band */
export type ClearanceBand = 'NONE' | 'PUBLIC_TRUST' | 'SECRET' | 'TOP_SECRET' | 'TS_SCI'

/** Theater code (OCONUS theaters only) */
export type TheaterCode = 'CENTCOM' | 'EUCOM' | 'INDOPACOM' | 'AFRICOM' | 'SOUTHCOM'
...
export interface AnalyticsEvent {
  id: string
  event_type: 'mos_search' | 'mos_page_view' | 'mos_filter_change' | 'job_click' | 'job_detail_view' | 'favorite_job_added' | 'account_created' | 'profile_updated'
  user_id: string | null
