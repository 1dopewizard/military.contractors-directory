<!--
  @file Chat with attachments component
  @description AI chat interface with file attachment support
-->
...
<template>
  <div class="flex flex-col h-[calc(100vh-12rem)] max-w-4xl mx-auto">
    <!-- Header -->
    <div class="mb-6">
      <h1 class="text-2xl font-semibold mb-2">Chat with Attachments</h1>
      <p class="text-sm text-muted-foreground">
        Send messages with image attachments to the AI
      </p>
    </div>
