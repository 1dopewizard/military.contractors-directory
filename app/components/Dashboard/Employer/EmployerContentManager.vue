...
// Fetch benefits
const { data: benefits, refresh: refreshBenefits } = await useFetch('/api/employer/benefits')

// Fetch programs
const { data: programs, refresh: refreshPrograms } = await useFetch('/api/employer/programs')
...
const saveBenefit = async () => {
  try {
    const { error } = await useFetch('/api/employer/benefits', {
      method: 'POST',
      body: benefitForm,
    })
...
const deleteBenefit = async (id: string) => {
  ...
  try {
    const { error } = await useFetch(`/api/employer/benefits/${id}`, {
      method: 'DELETE',
    })
...
const saveProgram = async () => {
  try {
    const { error } = await useFetch('/api/employer/programs', {
      method: 'POST',
      body: programForm,
    })
...
const deleteProgram = async (id: string) => {
  ...
  try {
    const { error } = await useFetch(`/api/employer/programs/${id}`, {
      method: 'DELETE',
    })
