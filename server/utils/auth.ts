...
async function sendMagicLinkEmail(email: string, url: string): Promise<void> {
  ...
  if (!resendApiKey) {
    ...
    if (isDev) {
      console.log('\n╔══════════════════════════════════════════════════════════════╗')
      console.log('║  DEV MODE: Magic Link (copy to browser to sign in)           ║')
      console.log('╠══════════════════════════════════════════════════════════════╣')
  ...
  if (!response.ok) {
    ...
    console.error('Failed to send magic link email. Status:', response.status, 'Body:', errorText)
    
    // In dev mode, log the magic link so testing can continue
    if (isDev) {
      console.log('\n╔══════════════════════════════════════════════════════════════╗')
      console.log('║  DEV MODE: Email failed, use this link to sign in            ║')
      console.log('╠══════════════════════════════════════════════════════════════╣')
      console.log(`║  Email: ${email}`)
      console.log(`║  URL: ${url}`)
      console.log('╚══════════════════════════════════════════════════════════════╝\n')
