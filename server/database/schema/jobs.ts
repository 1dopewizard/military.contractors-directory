...
export const job = sqliteTable('job', {
  ...
  clearanceData: text('clearanceData', { mode: 'json' }).$type<ClearanceData>(),
  compensationData: text('compensationData', { mode: 'json' }).$type<CompensationData>(),
  qualificationsData: text('qualificationsData', { mode: 'json' }).$type<QualificationsData>(),
  contractData: text('contractData', { mode: 'json' }).$type<ContractData>(),
  responsibilitiesData: text('responsibilitiesData', { mode: 'json' }).$type<string[]>(),
  toolsTech: text('toolsTech', { mode: 'json' }).$type<string[]>(),
  complianceData: text('complianceData', { mode: 'json' }).$type<ComplianceData>(),
  postingData: text('postingData', { mode: 'json' }).$type<PostingData>(),
  militaryMapping: text('militaryMapping', { mode: 'json' }).$type<MilitaryMapping>(),
