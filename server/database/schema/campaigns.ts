...
export const toastAd = sqliteTable(
  "toast_ad",
  {
    id: text("id")
      .primaryKey()
...
export const toastAdEvent = sqliteTable(
  "toast_ad_event",
  {
    id: text("id")
      .primaryKey()
      .$defaultFn(() => crypto.randomUUID()),
    toastAdId: text("toastAdId")
      .notNull()
      .references(() => toastAd.id, { onDelete: "cascade" }),
...
export const featuredContractor = sqliteTable(
  "featured_contractor",
  {
    id: text("id")
      .primaryKey()
...
export const featuredListing = sqliteTable(
  "featured_listing",
  {
    id: text("id")
      .primaryKey()
    ...
    requestData: text("requestData", {
      mode: "json",
    }).$type<FeaturedListingRequestData>(),
    createdAt: integer("createdAt", { mode: "timestamp" })
      .notNull()
      .$defaultFn(() => new Date()),
    updatedAt: integer("updatedAt", { mode: "timestamp" })
...
export const sponsoredAd = sqliteTable(
  "sponsored_ad",
  {
    id: text("id")
      .primaryKey()
    ...
    matchedMosCodes: text("matchedMosCodes", { mode: "json" }).$type<
      string[]
    >(),
...
export const sponsoredJob = sqliteTable(
  "sponsored_job",
  {
    id: text("id")
      .primaryKey()
